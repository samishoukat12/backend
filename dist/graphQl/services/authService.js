...
var bycrypt = __importStar(require("bcryptjs"));
...
var createAuthService = function () {
    return new AuthService(typedi_1.default.get(typedi_tokens_1.prismaToken));
};
    ...
    function AuthService(prisma) {
        ...
        this.register = function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                var checkExsitance, hashedPassword, user;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, bycrypt.hash(password, 12)];
                        case 2:
        ...
        this.login = function (email, password) { return __awaiter(_this, void 0, void 0, function () {
            var user, jwtKey, RefreashToken, AccessToken;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.prisma.user.findUnique({
                            where: {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, bycrypt.compare(password, user.password)];
                    case 2:
                        if (!(_a.sent())) {
                            throw new Error('password not correct');
                        }
                        jwtKey = "dasgvjtnkkweroutojfldmvturhglmslfjgibtrle";
                        RefreashToken = (0, jsonwebtoken_2.sign)({
                            userId: user.id
                        }, jwtKey, { expiresIn: 7 });
                        AccessToken = (0, jsonwebtoken_2.sign)({
                            userid: user.id
                        }, jwtKey, { expiresIn: 5 });
